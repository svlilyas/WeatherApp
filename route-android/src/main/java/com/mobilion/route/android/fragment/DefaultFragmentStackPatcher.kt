...
import com.mobilion.weatherapp.routecore.contains
import com.mobilion.weatherapproute.android.EmptyRoute
...
object DefaultFragmentStackPatcher : FragmentStackPatcher {
    ...
    private fun FragmentContainer.findFragmentOrThrow(element: RoutingStack.Element<*>): Fragment {
        return findFragmentOrNull(element)
            ?: throw IllegalStateException("Missing fragment for $element")
    }
}
