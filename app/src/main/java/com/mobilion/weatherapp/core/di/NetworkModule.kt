...
import com.mobilion.weatherapp.core.di.qualifers.DefaultOkHttpClientBuilder
import com.mobilion.weatherapp.core.di.qualifers.ProjectOkHttpClient
import com.mobilion.weatherapp.core.di.qualifers.ProjectRetrofit
import com.mobilion.weatherapp.core.network.*
...
object NetworkModule {
    ...
    fun provideProjectRetrofit(
        ...
        baseUrl(com.mobilion.weatherapp.BuildConfig.SERVICE_URL)
    ...
    fun provideClient(
        ...
        val loggingInterceptor = HttpLoggingInterceptor().apply {
            level = if (com.mobilion.weatherapp.BuildConfig.DEBUG) {
