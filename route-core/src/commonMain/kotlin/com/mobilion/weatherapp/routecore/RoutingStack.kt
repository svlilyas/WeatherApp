...
import com.mobilion.weatherapp.routecore.internal.ElementImpl
import com.mobilion.weatherapp.routecore.internal.RoutingStackImpl
...
interface RoutingStack<T : Route> :
    PlainStackInstructionSyntax<T, RoutingStack<T>>,
    Iterable<Element<T>> {
    ...
    abstract class Element<out T : Route> {
        ...
        companion object Factory {
             ...
             */
            operator fun <T : Route> invoke(route: T, key: Key = Key("key")): Element<T> =
